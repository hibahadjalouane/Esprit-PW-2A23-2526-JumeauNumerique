...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 12 avr. 2026 à 23:22
...
INSERT INTO `consultation` (`id_consultation`, `date_consultation`, `motif`, `diagnostic`, `notes`, `id_dossier`) VALUES
('CONS-001', '2024-04-17', 'Douleur', 'Normal', 'RAS', 'DOS-001');
...
INSERT INTO `dossier_medical` (`id_dossier`, `description`, `date_creation`, `id_patient`, `id_medecin`) VALUES
('DOS-001', 'Cardiologie', '2024-04-12', 'PAT-001', 'MED-001');
...
--
-- Déchargement des données de la table `ligne_ordonnance`
--

INSERT INTO `ligne_ordonnance` (`id_ligne`, `date_ordonnance`, `id_type_paiement`, `quantité`, `details`) VALUES
('LIG-001', '2024-04-17', 'TYP-001', 2, 'Doliprane');
...
INSERT INTO `ordonnance` (`id_ordonnance`, `date_ordonnance`, `instructions`, `statut`, `id_consultation`, `id_patient`) VALUES
('ORD-001', '2024-04-17', '2x par jour', 'active', 'CONS-001', 'PAT-001');
...
INSERT INTO `panne` (`id_Panne`, `date_de_panne`, `date_de_reparation`, `statut`, `description`, `id_ressource`) VALUES
('PAN-001', '2024-02-01', '2024-02-05', 'reparee', 'Surchauffe', 'RES-001');
...
INSERT INTO `ressources` (`id_ressource`, `Nom`, `Type`, `Dernier_Maintenence`, `Statut`, `Localisation`) VALUES
('RES-001', 'Scanner IRM', 'Imagerie', '2024-01-15', 'actif', 'Bloc A');
...
INSERT INTO `user` (`id_user`, `Nom`, `Prenom`, `Email`, `Mot de Passe`, `Statut_Cmpt`, `CIN`, `Service`, `id_role`) VALUES
('MED-001', 'Chabbi', 'Dr', 'chabbi@hopital.tn', 'pass123', 'actif', 11111111, 'Cardio', 'ROLE-MED'),
('P-345', 'Ben Ali', 'Mohamed', 'patient@test.tn', 'pass123', 'actif', 22222222, 'General', 'ROLE-PAT'),
('PAT-001', 'Ben Ali', 'Mohamed', 'patient@test.tn', 'pass123', 'actif', 22222222, 'General', 'ROLE-PAT');
